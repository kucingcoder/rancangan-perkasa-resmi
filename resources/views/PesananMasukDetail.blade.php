            ...
            <div class="flex">
                ...
                <div class="ml-4 flex flex-col">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat_tujuan" id="alamat_tujuan" cols="30" rows="8" style="resize: none;" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" required></textarea>
                    </div>
                </div>
            </div>

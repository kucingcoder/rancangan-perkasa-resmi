...
<div class="mt-6 flex gap-4">
    <input type="text" name="cari" id="cari" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Nama Pembeli/Nama Keranjang" required>
...
<script>
    ...
    function cari() {
        ...
        window.location.href = '/keranjang/cari/' + cari;
    }

...
<div id="dataModaltambah" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div class="bg-white w-full mx-4 md:w-3/6 md:mx-0 p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button
                class="text-gray-400 hover:text-gray-600"
                onclick="document.getElementById('dataModaltambah').classList.add('hidden');">
                ✖
            </button>
        </div>
        ...
        <form id="tambah" action="/akun-tambah" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-end space-x-2">
                <button type="button" class="mx-2 px-4 py-2 text-sm text-gray-700 bg-gray-200 rounded hover:bg-gray-300" onclick="document.getElementById('dataModaltambah').classList.add('hidden'); ">
                    Batal
                </button>
...
<div id="dataModalgantisandi" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div class="bg-white w-96 p-6 rounded-lg shadow-lg">
        <!-- Header -->
        <div class="flex justify-between items-center mb-4">
            ...
            <button
                class="text-gray-400 hover:text-gray-600"
                onclick="document.getElementById('dataModalgantisandi').classList.add('hidden'); ">
                ✖
            </button>
        </div>
        ...
        <form id="dataModalgantisandi" action="/akun-ganti-sandi" method="POST">
            ...
            <!-- Action Buttons -->
            <div class="flex justify-end space-x-2">
                <button type="button" class="mx-2 px-4 py-2 text-sm text-gray-700 bg-gray-200 rounded hover:bg-gray-300" onclick="document.getElementById('dataModalgantisandi').classList.add('hidden'); ;">
                    Batal
                </button>
...
<div id="dataModalgantifoto" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div class="bg-white w-96 p-6 rounded-lg shadow-lg">
        <!-- Header -->
        <div class="flex justify-between items-center mb-4">
            <h2 id="modalTitle" class="text-lg font-bold text-gray-700">Ganti Kata Sandi</h2>
            <button
                class="text-gray-400 hover:text-gray-600"
                onclick="document.getElementById('dataModalgantifoto').classList.add('hidden'); ">
                ✖
            </button>
        </div>
        ...
        <form id="dataModalgantifoto" action="/akun-ganti-foto" method="POST" enctype="multipart/form-data">
            ...
            <!-- Action Buttons -->
            <div class="flex justify-end space-x-2">
                <button type="button" class="mx-2 px-4 py-2 text-sm text-gray-700 bg-gray-200 rounded hover:bg-gray-300" onclick="document.getElementById('dataModalgantifoto').classList.add('hidden'); ;">
                    Batal
                </button>
                <button type="submit" class="mx-2 px-4 py-2 text-sm text-white bg-yellow-500 rounded hover:bg-yellow-600">
                    Ganti Foto

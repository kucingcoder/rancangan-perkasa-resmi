...
<div class="mt-6 flex gap-4 flex-wrap justify-center md:justify-start items-center">
    ...
    <div class="w-full md:w-1/4 p-4 rounded-lg bg-grey-100 shadow shadow-lg border border-grey-300">
        ...
        <div class="mt-4 flex">
            <button onclick="window.location.href='/laporan/{{$item->id}}'" class="w-full px-4 py-2 text-sm text-white bg-blue-950 rounded hover:bg-blue-600">Detail</button>
        </div>
    </div>
    @endforeach
</div>
...
<script>
    ...
    function cari() {
        ...
        window.location.href = '/laporan/cari/' + cari;
    }
</script>
@endsection
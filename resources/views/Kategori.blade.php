@extends('layouts.App')
@section('title', 'Rancangan Perkasa | Kategori')
...
<h2 class="text-2xl md:text-4xl text-center font-bold text-gray-700 mb-2">Daftar Kategori</h2>
...
<div id="dataModal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white w-96 p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 id="modalTitle" class="text-lg font-bold text-gray-700">Kategori Baru</h2>
    ...
    <table class="w-full bg-white border border-gray-200 table-auto" id="daftar-kategori">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td class="border-gray-200 px-4 py-2 text-sm text-gray-700">
                    <button onclick="edit('{{ $item->id }}','{{ $item->nama_kategori }}',`{{ $item->spesifikasi }}`,'{{ $item->satuan }}','{{ $item->biaya_sales }}')" class="px-3 py-1 text-sm text-white bg-yellow-500 rounded hover:bg-yellow-600">Edit</button>
...
<script>
    ...
    function edit(id, nama_kategori, spesifikasi, satuan, biaya_sales) {
        ...
        document.getElementById('spesifikasi_edit').value = spesifikasi

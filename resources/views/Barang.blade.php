    ...
    <div class="bg-white w-96 p-6 rounded-lg shadow-lg">
        ...
        <form id="tambahBarang" action="/barang-tambah" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_barang" name="nama_barang" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Masukkan nama barang" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="harga" name="harga" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Masukkan harga" required>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1" for="stok">Stok</label>
                <input type="number" id="stok" name="stok" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Masukkan jumlah stok" required>
            </div>
    ...
    <div class="bg-white w-96 p-6 rounded-lg shadow-lg">
        ...
        <form id="edit" action="/barang-edit" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_barang_edit" name="nama_barang_edit" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Masukkan nama barang" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="harga_edit" name="harga_edit" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Masukkan harga" required>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1" for="stok_edit">Stok</label>
                <input type="number" id="stok_edit" name="stok_edit" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Masukkan stok" required>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1" for="foto_edit">Foto</label>
                <input type="file" id="foto_edit" name="foto_edit" accept="image/png, image/jpeg, image/jpg" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
...
<script>
    ...
    function edit(id, nama_barang, kategori, harga, stok, foto) {
        ...
        // Menampilkan foto barang di form edit
        const fotoPreview = document.getElementById('foto_preview_edit');
